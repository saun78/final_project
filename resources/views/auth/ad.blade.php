...
<head>
  ...
  <title>Your Company - Auto Service & Spare Parts</title>
  <!-- Bootstrap CSS -->
  ...
  <style>
    ...
    .hero {
      background: url('https://images.unsplash.com/photo-1570129477492-45c003edd2be?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80') center/cover no-repeat;
      color: white;
      padding: 180px 0;
      text-align: center;
      position: relative;
