        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Edit Receipt - {{ $order->order_number }}</h4>
                                    ...
                                    <div class="order-item row mb-3">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" class="form-control subtotal-display" 
                                                   value="${{ number_format($orderItem->quantity * $orderItem->price, 2) }}" readonly>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">&nbsp;</label>
                                            <div>
                                                <button type="button" class="btn btn-danger btn-sm remove-item"
                                                        style="display: {{ count($order->orderItems) > 1 ? 'inline-block' : 'none' }};">
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <strong id="totalAmount">${{ number_format($order->amount, 2) }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $('#addItem').on('click', function() {
        ...
        $newItem.find('input, select').each(function() {
            ...
            if ($field.is('select')) {
                ...
                $field.val('1');
            } else if ($field.hasClass('subtotal-display')) {
                $field.val('$0.00');
